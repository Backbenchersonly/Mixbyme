...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002258005675"))
...
USER_REPLY_TEXT = os.environ.get("USER_REPLY_TEXT", "❌ 𝙿𝚕𝚎𝚊𝚜𝚎 𝙰𝚟𝚘𝚒𝚍 𝙳𝚒𝚛𝚎𝚌𝚝 𝙼𝚎𝚜𝚜𝚊𝚐𝚎𝚜. 𝙸'𝚖 𝚆𝚘𝚛𝚔𝚒𝚗𝚐 𝙵𝚘𝚛 𝙾𝚗𝚕𝚢  @ntmpro")
...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://Bapusarkarbjppvt:2HqLJGdyuBCclxDz@cluster0.khf1x.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
#your database name
...
OWNER_TAG = os.environ.get("OWNER_TAG", "Backbenchers")
...
SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "4943e4169c0683d4df1dc7a557dfc743d4bbf25d")
